    ...
    context === "price"
      ? isManualPricingMode
        ? {
            ...
            description: dateLabel
              ? "Donkeyfolio is carrying forward the last price. Add this date only if it needs its own value."
        ...
        : {
            ...
            description: dateLabel
              ? "Donkeyfolio is carrying forward the last available price. Refetch prices if this was a trading day."
      ...
      : context === "basis"
        ? {
            ...
            description:
              "Update what you paid for this holding so Donkeyfolio can calculate gain/loss.",
          }
        : {
