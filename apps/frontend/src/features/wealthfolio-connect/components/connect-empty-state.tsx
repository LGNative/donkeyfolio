    ...
    <div className="flex min-h-[calc(100vh-12rem)] flex-col items-center justify-center px-4 py-6">
      <div className="w-full max-w-3xl space-y-8 sm:space-y-12">
        ...
        <header className="text-center">
          <img alt="Donkeyfolio" className="mx-auto mb-4 h-16 w-16" src="/logo-vantage.png" />
          ...
          <h1 className="mb-2 text-xl font-semibold tracking-tight">Donkeyfolio Connect</h1>
